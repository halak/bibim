...
namespace Bibim.Bab.Controls
{
    public class PlaceholderTextBox : System.Windows.Controls.TextBox
    {
        ...
        {
            if (DependencyPropertyHelper.GetValueSource(this, PlaceholderTextBox.HorizontalContentAlignmentProperty).BaseValueSource == BaseValueSource.Local
                && DependencyPropertyHelper.GetValueSource(this, PlaceholderTextBox.TextAlignmentProperty).BaseValueSource != BaseValueSource.Local)
            {
