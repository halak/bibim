...
{
    [ClassID('e', 's', 'p', '4')]
    public sealed class EvalPoint4Sequence : EvalSequenceTemplate<Point4, Point4Sequence>
    {
        protected override Point4 Interpolate(Point4 a, Point4 b, float t)
        {
            ...
            result.Z = (int)((float)a.Z + ((float)(b.Y - a.Z)) * t);
            result.W = (int)((float)a.W + ((float)(b.Y - a.W)) * t);
            return result;
        }
    }
}